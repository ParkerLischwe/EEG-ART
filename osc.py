...
def process_eeg_signal(address, *args):
    ...
    if num_samples_processed >= BUFFER_SIZE:
        ...
        if counter == 30:
            ...
            # bt_ratio is beta/theta which means that when this ratio is large, there is more focus and therefore larger attraction because it is less of a flow state (lower beta/theta means greater flow state and therefore more less attraction)
